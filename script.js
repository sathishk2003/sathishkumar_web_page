...
const Tools = () => {
    const getTools = () => {
        return [{
                ...
                id: 1,
                image: "photo-1492011221367-f47e3ccd77a0.webp",
                label: "Weather",
                name: "Cloudly"
            }, {
                icon: "fa-solid fa-calculator-simple",
                id: 2,
                image: "photo-1587145820266-a5951ee6f620.webp",
                label: "Calc",
                name: "Mathio"
            }, {
                icon: "fa-solid fa-piggy-bank",
                id: 3,
                image: "photo-1579621970588-a35d0e7ab9b6.webp",
                label: "Bank",
                name: "Cashy"
            }, {
                icon: "fa-solid fa-plane",
                id: 4,
                image: "photo-1436491865332-7a61a109cc05.webp",
                label: "Travel",
                name: "Fly-er-io-ly"
            }, {
                icon: "fa-solid fa-gamepad-modern",
                id: 5,
                image: "photo-1612287230202-1ff1d85d1bdf.webp",
                label: "Games",
                name: "Gamey"
            }, {
                icon: "fa-solid fa-video",
                id: 6,
                image: "photo-1578022761797-b8636ac1773c.webp",
                label: "Video Chat",
                name: "Chatty"
            }].map((tool) => {
            const styles = {
...
const Restaurants = () => {
    const getRestaurants = () => {
        return [{
                ...
                id: 1,
                image: "photo-1606131731446-5568d87113aa.webp",
                title: "Burgers"
            }, {
                desc: "The worst ice-cream around",
                id: 2,
                image: "photo-1576506295286-5cda18df43e7.webp",
                title: "Ice Cream"
            }, {
                desc: "This 'Za be gettin down",
                id: 3,
                image: "photo-1590947132387-155cc02f3212.webp",
                title: "Pizza"
            }, {
                desc: "BBQ ain't need no rhyme",
                id: 4,
                image: "photo-1529193591184-b1d58069ecdd.webp",
                title: "BBQ"
            }].map((restaurant) => {
            const styles = {
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://www.youtube.com/channel/UClDhQkIb436RdKczYRf538g", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-youtube" }),
                    React.createElement("span", null, "sathish")),
